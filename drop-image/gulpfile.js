...
const projectDistFolder = path.join(rootFolder, '..', 'src', 'app', 'drop-image');
...
gulp.task('rollup:fesm', function () {
  ...
  // transform the files here.
    ...
    .pipe(gulp.dest(projectDistFolder));
});
...
gulp.task('rollup:umd', function () {
  ...
  // transform the files here.
    ...
    .pipe(rename('dialog-service.umd.js'))
    .pipe(gulp.dest(distFolder))
    .pipe(gulp.dest(projectDistFolder));
});
